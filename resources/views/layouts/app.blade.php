...
<head>
    ...
    <title>@yield('title', 'Bincom Election Results')</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('polling-unit.*') ? 'active' : '' }}"
                       href="{{ route('polling-unit.index') }}">
                        <i class="bi bi-search me-1"></i>Polling Unit Results
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('lga-results.*') ? 'active' : '' }}"
                       href="{{ route('lga-results.index') }}">
                        <i class="bi bi-table me-1"></i>LGA Results
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('new-result.*') ? 'active' : '' }}"
                       href="{{ route('new-result.index') }}">
...
<footer>
    <div class="container">
        &copy; {{ date('Y') }} Bincom Election Results System &mdash; 2011 Nigerian General Elections Data
    </div>
</footer>
